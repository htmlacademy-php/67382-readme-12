        ...
        <div class="popular__sorting sorting">
            ...
            <ul class="popular__sorting-list sorting__list">
                ...
                <li class="sorting__item<?= ($sortings_item === 'views') ? ' sorting__item--popular' : ''; ?> ">
                    <a class="sorting__link<?= ($sorting_type === $sortings_item) ? ' sorting__link--active' : ''; ?><?= ($sorting_order === 'asc') ? ' sorting__link--reverse' : ''; ?>" href="<?= $filters_type ? 'popular.php?type_id=' . $filters_type . '&sorting=' . $sortings_item : 'popular.php?sorting=' . $sortings_item; ?><?= (($sorting_type !== $sortings_item) || ($sorting_order === 'asc')) ? '&order=desc' : '&order=asc'; ?>">
            ...
            <ul class="popular__filters-list filters__list">
                ...
                <?php if ($posts_types): ?>
                    ...
                    <li class="popular__filters-item filters__item">
                        <a class="filters__button filters__button--<?= $post_type['alias']; ?><?=((int) $post_type['id'] === $filters_type) ? ' filters__button--active' : ''; ?> button" href="popular.php?type_id=<?= $post_type['id']; ?>">
