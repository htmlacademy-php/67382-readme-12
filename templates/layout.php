...
<body class="page<?= (($active_page === 'index') ? ' page--main' : '') ?>">
...
<header class="header<?= (($active_page === 'index') ? ' page__header' : '') ?>">
    <div class="header__wrapper container<?= (($active_page === 'index') ? ' page__header-wrapper' : '') ?>">
        <div class="header__logo-wrapper<?= (($active_page === 'index') ? ' page__logo-wrapper' : '') ?>">
            <?php if ($active_page === 'index'): ?>
                <span class="header__logo-link header__logo-link--active">
        ...
        <?php if (isset($user_name) && ($active_page !== 'index')): ?>
        <form class="header__search-form form" action="search.php" method="get">
            <div class="header__search">
                <label class="visually-hidden">Поиск</label>
                <input class="header__search-input form__input" type="search" name="search" value="<?= htmlspecialchars($search_form_text ? $search_form_text : '') ?>">
...
<footer class="footer<?= (($active_page === 'index') ? ' footer--main' : '') ?>">
