                ...
                <div class="post__author">
                    <a class="post__author-link" href="#" title="Автор">
                        <div class="post__avatar-wrapper">
                            <img class="post__author-avatar" src="<?= $post['avatar'] ? 'uploads/avatars/' . strip_tags($post['avatar']) : 'img/icon-input-user.svg'; ?>" alt="Аватар пользователя" style="max-width: 40px!important;max-height: 40px!important;">
                        </div>
