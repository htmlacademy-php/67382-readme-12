            ...
            <article class="popular__post post <?=$val['type'];?>">
                ...
                <?php switch ($val['type']):
                    case 'post-quote': ?>
                        ...
                        <?php break;
                    case 'post-text': ?>
                        <?=cut_post(htmlspecialchars($val['content']));?>
                        <?php break;
                    case 'post-link': ?>
                        <div class="post-link__wrapper">
                            <a class="post-link__external" href="http://<?=strip_tags($val['content']);?>" title="Перейти по ссылке">
                                ...
                                <span><?=strip_tags($val['content']);?></span>
                            </a>
                        </div>
                        <?php break;
                    case 'post-video': ?>
                    ...
                    case 'post-photo': ?>
                        <div class="post-photo__image-wrapper">
                            <img src="img/<?=strip_tags($val['content']);?>" alt="Фото от пользователя" width="360" height="240">
                        </div>
                        <?php break;
                endswitch ?>
                </div>
