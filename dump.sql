...
INSERT INTO posts SET user_id = 2, type_id = 5, post_date = '2020-09-08 15:06:18', title = 'Лучшие курсы', content='Самые лучшие курсы по фронтенд-разработке', content_add='www.htmlacademy.ru', link_icon='icon-htmlacademy.svg', is_repost = 0, views_total = 7;
